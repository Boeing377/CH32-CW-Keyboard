...
extern void USBH_AnalyseType(uint8_t *pdev_buf, uint8_t *pcfg_buf,
        uint8_t *ptype);
...
extern uint8_t USBH_EnumHubPortDevice(uint8_t hub_port, uint8_t *paddr,
        uint8_t *ptype);
extern void KB_AnalyzeKeyValue(uint8_t index, uint8_t intf_num, uint8_t *pbuf,
        uint16_t len);
